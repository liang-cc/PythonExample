...
def main(fileNames=None):
    ...
    genres = ['Classical','Electronic','Folk, World, & Country', 'Jazz', 'Pop', 'Blues', 'Hip Hop', 'Reggae', 'Latin', 'Stage & Screen', 'Rock', 'Funk / Soul']
    ...
    for genre in genres:
        genreRdd = rdd.filter(lambda line: genre in line)
